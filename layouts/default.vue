<template>
    <div class="layout">
      <header>
        <nav
          x-data="{ isOpen: false }"
          class="relative bg-white shadow dark:bg-primary_dark"
        >
        ...
        <div class="container p-6 mx-auto">
          <div class="lg:flex">
            <div class="w-full -mx-6 lg:w-2/5">
              <div class="px-6">
                <a href="#">
                  <img class="w-auto h-7" src="/img/main_logowhite.svg" alt="" />
                </a>
            ...
            <div class="mt-6 lg:mt-0 lg:flex-1">
              ...
              >
                ...
                <div>
                  <h3 class="text-gray-700 uppercase dark:text-white">Články</h3>
                  <a
                    href="#"
                    class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline"
                    >Tec</a
                ...
                <div>
                  <h3 class="text-gray-700 uppercase dark:text-white">Kontakt</h3>
                  <span
                    class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline"
                    ><a href="https://www.instagram.com/cznetwork.cz/" target="_blank">Instagram</a></span
                  >
                  <span
                    class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline"
          ...
          <div>
            <div
              class="flex items-center justify-between text-center text-gray-500 dark:text-gray-400"
            >
              <span> © Copyright {{ date }} - Všechna práva vyhrazena </span>
              <span>Vytvořeno "doplnit"</span>
            </div>
          </div>
        </div>
      </footer>

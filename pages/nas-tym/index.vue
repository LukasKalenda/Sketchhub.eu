      ...
      >
          ...
          <div class="lg:max-w-lg">
            ...
            <div class="mt-8 space-y-5">
              ...
              >
                ...
                <span class="mx-2">Zpracování modelů</span>
              </p>
              ...
              >
                ...
                <span class="mx-2">3D výrobek</span>
              </p>
              ...
              >
                ...
                <span class="mx-2">Popis na stránce</span>
              </p>
            </div>
          </div>
          <div class="pt-3">
            <button
              type="button"
              class="h-10 px-4 m-1 text-white transition-colors duration-300 transform bg-blue-500 rounded-md hover:bg-blue-400 focus:outline-none focus:bg-blue-400"
            >
        ...
        <div class="flex items-center justify-center w-full h-96 lg:w-1/2">
          <img
            ...
            src="/img/undraw_engineering.svg"
            alt="Coworking team"
          />
        </div>
      </div>
        ...
        >
          ...
          >
            ...
            <div class="flex mt-4 -mx-2">
              <a
                href="mailto:lukas.kalenda@sketchub.eu"
              ...
              <a
                href="https://www.linkedin.com/in/lukas-kalenda/"
                class="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white"
                aria-label="LinkedIn"
              >
                <svg
              ...
              <a
                href="https://github.com/LukasKalenda"
                class="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white"
                aria-label="Github"
              >
                <svg
          ...
          >
            ...
            <div class="flex mt-4 -mx-2">
              <a
                href="mailto:adam.hurt@sketchub.eu"
                class="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white"
                aria-label="E-mail"
              >
                <svg
          ...
          >
            ...
            <p
              class="mt-4 text-gray-500 dark:text-gray-300 group-hover:text-gray-300"
            >
              Zabývám se zejména modelováním objektů a jejich převodem do 3D
              programu. Tvořím také 3D animace, které jsou využívány v našich
              videích.
            </p>

            <div class="flex mt-4 -mx-2">
              <a
                href="mailto:michal.krulis@sketchub.eu"
                class="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300 group-hover:text-white"
                aria-label="E-mail"
              >
                <svg
